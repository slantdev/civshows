...
<section <?php echo $section_id_attr; ?> class="civ-shows-cards-section section-shows-cards py-30 bg-white relative" style="<?php echo esc_attr($section_style); ?>">
  ...
  <div class="civ-section-container container mx-auto px-4 relative z-10">

    <?php if (!empty($intro['title'])) : ?>
      <div class="civ-shows-cards-intro mb-12 max-w-3xl">
    ...
    <div class="civ-shows-cards-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      ?>
        ...
        <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>" class="civ-shows-card-link group relative aspect-5/4 rounded-2xl overflow-hidden block shadow-md hover:shadow-xl transition-shadow">
          ...
          <div class="civ-shows-card-content relative h-full flex flex-col justify-end">
            <div class="civ-shows-card-logo p-6 grow flex items-end justify-start">
              <?php if ($logo_image) : ?>
                <img src="<?php echo esc_url($logo_image); ?>" alt="<?php echo esc_attr($card_title); ?> Logo" class="w-2/3 h-auto drop-shadow-lg">
              <?php endif; ?>
            </div>

            <div class="civ-shows-card-footer px-6 py-4 flex justify-between items-center relative z-10" style="background-color: <?php echo esc_attr($bg_color); ?>; color: <?php echo esc_attr($text_color); ?>;">
              <div>
