...
$gallery_count++;
$gallery_id_prefix = 'gallery-' . get_the_ID() . '-' . $gallery_count;
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-18">
      ...
      <div class="group flex flex-col">
        <a href="<?php echo get_stylesheet_directory_uri() . "/assets/images/demo/featured1.jpg" ?>"
          data-fancybox="<?php echo esc_attr($gallery_id_prefix . '-1'); ?>"
        ...
        <div style="display: none;">
          <a href="https://lipsum.app/id/60/1600x1200"
            data-fancybox="<?php echo esc_attr($gallery_id_prefix . '-1'); ?>"
            data-caption="<h3 class='font-semibold text-lg mb-2'>South Melbourne's BIGGEST Show</h3><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>">
            <img src="https://lipsum.app/id/60/1600x1200" alt="Bendigo Leisurefest">
          </a>
          <a href="https://lipsum.app/id/63/1600x1200"
            data-fancybox="<?php echo esc_attr($gallery_id_prefix . '-1'); ?>"
            data-caption="<h3 class='font-semibold text-lg mb-2'>South Melbourne's BIGGEST Show</h3><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>">
            <img src="https://lipsum.app/id/63/1600x1200" alt="Bendigo Leisurefest">
          </a>
        </div>
      ...
      <div class="group flex flex-col">
        <a href="<?php echo get_stylesheet_directory_uri() . "/assets/images/demo/featured2.jpg" ?>"
          data-fancybox="<?php echo esc_attr($gallery_id_prefix . '-2'); ?>"
        ...
        <div style="display: none;">
          <a href="https://lipsum.app/id/61/1600x1200"
            data-fancybox="<?php echo esc_attr($gallery_id_prefix . '-2'); ?>"
            data-caption="<h3 class='font-semibold text-lg mb-2'>Western Melbourne's BIGGEST Show</h3><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>">
            <img src="https://lipsum.app/id/61/1600x1200" alt="Bendigo Leisurefest">
          </a>
          <a href="https://lipsum.app/id/62/1600x1200"
            data-fancybox="<?php echo esc_attr($gallery_id_prefix . '-2'); ?>"
            data-caption="<h3 class='font-semibold text-lg mb-2'>Western Melbourne's BIGGEST Show</h3><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>">
            <img src="https://lipsum.app/id/62/1600x1200" alt="Bendigo Leisurefest">
          </a>
        </div>
