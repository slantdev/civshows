...
<section <?php echo $section_id_attr; ?> class="civ-home-hero-section relative w-full h-[600px] md:h-[700px] lg:h-svh bg-civ-blue-950 overflow-x-hidden group section-home-hero-slider" style="<?php echo esc_attr($section_style); ?>">
  ...
  <div class="civ-hero-main-slider swiper main-slider w-full h-full">
    <div class="swiper-wrapper">
      ...
      ?>
        <div class="swiper-slide relative flex items-center justify-center pt-20 lg:pt-36 lg:pb-[86px] 2xl:pt-28">
            ...
            <div class="civ-hero-text lg:col-span-9 xl:col-span-8 2xl:col-span-7 text-white lg:pl-16">
              ...
              ?>
                <div class="mb-6 md:mb-8" data-swiper-parallax="-300">
                  <?php echo wp_get_attachment_image($l_id, 'large', false, ['class' => 'max-h-20 md:max-h-24 2xl:max-h-28 w-auto object-contain object-left']); ?>
                </div>
              <?php endif; ?>

              <?php if ($title) : ?>
                <h2 class="text-4xl md:text-[42px] 2xl:text-6xl font-bold mb-4" data-swiper-parallax="-400"><?php echo esc_html($title); ?></h2>
              <?php endif; ?>
  ...
  <div class="civ-hero-thumbs absolute top-0 bottom-0 left-0 z-20 container mx-auto px-4 xl:px-8 lg:pt-36 lg:pb-[86px] 2xl:pt-28 pointer-events-none">
          ...
          <div class="swiper-wrapper flex-col">
            ...
            ?>
              <div class="swiper-slide h-auto! cursor-pointer transition-all duration-300">
                <div class="slide-thumb-wrapper p-4 2xl:p-6 relative transition-all duration-300">
                  <div class="slide-thumb-indicator h-[3px]"></div>
                  <div class="pt-3">
                    <h3 class="text-white font-bold text-base xl:text-xl mb-2"><?php echo esc_html($title); ?></h3>
                    <div class="text-gray-200 text-xs 2xl:text-sm leading-relaxed font-light line-clamp-2 2xl:line-clamp-3">
                      <?php echo wp_kses_post($description); ?>
                    </div>
                  </div>
                </div>
