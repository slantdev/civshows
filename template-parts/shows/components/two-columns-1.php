  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-20">
      ...
      <div>
        ...
        <div class="mb-8">
          <p class="font-bold text-base md:text-lg xl:text-lg mb-1">2025 Pricing:</p>
          <p class="text-base md:text-lg xl:text-lg text-gray-800 mb-1">
            <span class="font-bold">Adult:</span> $20.00 | <span class="font-bold">Concession:</span> $18.00
          </p>
          <p class="text-lg text-gray-800 leading-relaxed">
            <span class="font-bold">Children:</span> Children under 15 are FREE but must be accompanied by a paying adult.
          </p>
        </div>

        <a href="#" class="inline-block bg-civ-orange-500 hover:bg-civ-orange-600 text-white font-bold uppercase py-3 px-8 text-sm tracking-wide rounded-sm transition-colors mb-8">
          Ticket On Sale Soon
        </a>
        ...
        <div class="text-gray-700 space-y-4 mb-8">
          ...
          <p>
            If you need assistance you can contact our ticketing company via:<br>
            email – info@oztix.com.au<br>
            phone – 1300 762 545
          </p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
      ...
      <div>
        <h3 class="text-xl md:text-2xl font-extrabold text-black uppercase mb-8 leading-tight">
          How You Can Prepare and Get the Most Out of the Melbourne Caravan & Camping Leisurefest
        </h3>

        <ul class="space-y-6">
          <li class="flex items-start gap-4">
            <div class="shrink-0 mt-1">
              <div class="w-6 h-6 rounded-full bg-civ-orange-500 flex items-center justify-center text-white">
      ...
      <div>
        <h3 class="text-xl md:text-2xl font-extrabold text-black uppercase mb-8">Policies</h3>
