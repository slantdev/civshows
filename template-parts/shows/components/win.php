  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
      ...
      <div class="w-full lg:w-5/12">
        ...
        <button class="bg-civ-orange-500 hover:bg-civ-orange-600 text-white font-bold uppercase text-sm py-3 px-8 rounded-sm transition-colors shadow-sm w-full sm:w-auto">
          Ticket On Sale Soon
        </button>
      </div>
      ...
      <div class="w-full lg:w-7/12">
        ...
        <div class="md:text-base text-gray-800 space-y-4 mb-8 leading-relaxed">
          ...
          <p>
            You can go in the draw to WIN BIG by attending either the 2025 Melbourne Caravan & Camping Leisurefest, 2025 Bendigo Caravan & Camping Leisurefest or the 2025 Geelong Caravanning & Adventure Leisurefest. The winner will be drawn in December 2025.
          </p>
        </div>

        <h4 class="text-lg font-bold text-black mb-6">How you can WIN!</h4>
          ...
          <div class="flex gap-4">
            <div class="shrink-0 mt-1">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700" viewBox="0 0 24 24" fill="currentColor">
                <path fill-rule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.41 15.41L12 16l5.41-5.41L16 9.17l-4 4-2.59-2.58L8 12l2.59 5.41z" clip-rule="evenodd" />
                <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zm-1-14l4 4-4 4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
            <div>
            ...
            <div>
              ...
              <div class="text-gray-700 leading-relaxed">
                ...
                <ul class="list-[lower-alpha] ml-4 mt-1 space-y-1">
                  ...
                  <li>Scan all QR Code Checkpoints using the app.</li>
                  <li>Fill out and submit the online entry form within the app, including your contact details and any other requested information.</li>
                  <li>By completing all steps, you will gain 10 entries into the competition.</li>
                </ul>
              </div>
