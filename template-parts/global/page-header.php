  ...
  <div class="civ-page-header-content container mx-auto px-4 md:px-6 lg:px-8 pt-40 pb-10 md:pt-52 xl:pb-16 xl:px-8 xl:pt-72 relative z-10">
    <div class="flex flex-col lg:flex-row items-end justify-between gap-6 lg:gap-10 2xl:gap-12">
      <div class="w-full lg:w-3/5 2xl:w-1/2">
        <?php if ($show_title): ?>
          <h1 class="civ-page-header-title text-4xl md:text-5xl 2xl:text-6xl font-semibold leading-tight" style="color: <?php echo esc_attr($title_color); ?>;">
            <?php echo wp_kses_post($title_text); ?>
          </h1>
        <?php endif; ?>

        <?php if ($show_subtitle && $subtitle_text): ?>
          <div class="civ-page-header-subtitle text-base xl:text-[17px]" style="color: <?php echo esc_attr($subtitle_color); ?>;">
    ...
    <?php if ($show_breadcrumbs): ?>
      <div class="civ-page-header-breadcrumbs flex">
        <div class="w-full lg:w-3/5 2xl:w-1/2">
          ...
          <?php civ_breadcrumbs(['text_color' => $breadcrumbs_text_color, 'wrap' => false]); ?>
        </div>
      </div>
    <?php endif; ?>
  </div>
