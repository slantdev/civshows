    ...
    <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-12 gap-x-4 gap-y-8 lg:gap-8">
      ...
      <div class="col-span-2 md:col-span-3 xl:col-span-5 flex flex-col md:flex-row gap-6 items-start xl:gap-8">
        ...
        <div class="civ-footer-about-content footer-about-content pr-0 xl:pr-6 prose prose-sm xl:max-w-none" style="color: inherit;">
          <?php if (!empty($footer_about['about_civ'])) : ?>
            <div class="[&_h3]:font-semibold [&_h3]:text-[15px] [&_h3]:text-inherit [&_h3]:mb-4 [&_h3]:mt-0 [&_h3]:leading-tight [&_p]:text-[13px] [&_p]:leading-relaxed">
      ...
      <div class="col-span-2 md:col-span-1 xl:col-span-3">
        ...
        <?php if (!empty($footer_subscribe['enable_subscribe'])) : ?>
          <h3 class="font-bold text-base md:text-lg xl:text-lg mb-4 lg:mb-6" style="color: inherit; opacity: 0.8;"><?php echo esc_html($footer_subscribe['subscribe_heading']); ?></h3>

          <?php if ($footer_subscribe['subscribe_form_shortcode']) : ?>
            <?php echo do_shortcode($footer_subscribe['subscribe_form_shortcode']); ?>
          <?php endif; ?>
