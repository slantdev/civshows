...
<div id="<?php echo esc_attr($slider_id); ?>" class="civ-media-slider-wrapper media-slider-wrapper relative <?php echo esc_attr($class); ?>">
  ...
  <?php if ($is_slider) : ?>
    <!-- Navigation -->
    <div class="media-prev absolute bottom-0 lg:top-1/2 lg:bottom-auto left-0 transform lg:-translate-x-1/2 xl:-left-10 lg:-translate-y-1/2 z-10 cursor-pointer">
      <div class="w-8 h-8 md:w-12 md:h-12 rounded-full bg-gray-300 hover:bg-gray-400 flex items-center justify-center transition-colors text-white shadow-sm">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
          <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
        </svg>
      </div>
    </div>

    <div class="media-next absolute bottom-0 lg:bottom-auto lg:top-1/2 right-0 transform lg:translate-x-1/2 xl:-right-10 lg:-translate-y-1/2 z-10 cursor-pointer">
      <div class="w-8 h-8 md:w-12 md:h-12 rounded-full bg-civ-blue-500 hover:bg-civ-blue-600 flex items-center justify-center transition-colors text-white shadow-sm">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
    ...
    <!-- Pagination -->
    <div class="media-pagination flex justify-center pt-6 pb-2 md:pt-10 md:pb-4 gap-1 md:gap-2"></div>
  <?php endif; ?>
