...
<div>
	...
	<div>
		<article class="bg-white border! border-gray-200! rounded-lg p-4! md:p-6! flex flex-col md:flex-row gap-6 md:gap-8 shadow-sm hover:shadow-md transition-shadow my-6! xl:my-8!">
